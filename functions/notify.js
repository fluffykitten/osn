/**
 * functions/notify.js
 * Cloudflare Pages Functions Endpoint: /notify
 * Menggunakan Resend API untuk mengirimkan notifikasi email pendaftaran.
 */
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    // Template Siswa dengan Rincian Informasi Personal Pendaftaran
