...
import { Search, Filter, BookOpen, Zap, Tag, ArrowRight, X, ExternalLink, Image as ImageIcon } from 'lucide-react';
          ...
          >
            ...
            {q.diagram_url && (
              <div
                ...
                className="inline-flex items-center gap-2.5 p-2 bg-slate-50 hover:bg-sky-50 border border-slate-200 hover:border-sky-300 rounded-xl cursor-pointer transition-all shadow-2xs group"
                title="Klik untuk melihat diagram ukuran penuh"
              >
                <img
                  src={q.diagram_url}
                  alt="Thumbnail Diagram"
                  className="w-12 h-12 object-contain rounded-lg bg-white border border-slate-200 group-hover:scale-105 transition-transform"
                />
                <div className="text-left">
                  <p className="text-[11px] font-bold text-slate-800 flex items-center gap-1 group-hover:text-sky-700 transition-colors">
